...
func (i *IDTokenHandleHelper) GetAccessTokenHash(ctx context.Context, requester oauth21.AccessRequester, responder oauth21.AccessResponder) string {
...
func (i *IDTokenHandleHelper) generateIDToken(ctx context.Context, lifespan time.Duration, fosr oauth21.Requester) (token string, err error) {
...
func (i *IDTokenHandleHelper) IssueImplicitIDToken(ctx context.Context, lifespan time.Duration, ar oauth21.Requester, resp oauth21.AuthorizeResponder) error {
...
func (i *IDTokenHandleHelper) IssueExplicitIDToken(ctx context.Context, lifespan time.Duration, ar oauth21.Requester, resp oauth21.AccessResponder) error {
	token, err := i.generateIDToken(ctx, lifespan, ar)
	if err != nil {
		return err
	}
